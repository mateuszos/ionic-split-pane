import { ContentChildren, Component, ElementRef, EventEmitter, forwardRef, Input, Output, QueryList, NgZone,
  Renderer, OnDestroy, AfterViewInit, ViewEncapsulation
} from '@angular/core';
import { Ion } from '../ion';
...
@Component({
  ...
  providers: [
    { provide: RootNode, useExisting: forwardRef(() => SplitPaneComponent) },
  ],
  encapsulation: ViewEncapsulation.None,
})
export class SplitPaneComponent extends Ion implements RootNode, OnDestroy, AfterViewInit {
   ...
   */
  @Output() ionChange: EventEmitter<SplitPaneComponent> = new EventEmitter<SplitPaneComponent>();
